...
def is_valid(current_result, values, test_result):
    ...
    return is_valid(current_result + values[0], values[1:], test_result) or is_valid(current_result * values[0], values[1:], test_result) or is_valid(concat(current_result, values[0]), values[1:], test_result)
